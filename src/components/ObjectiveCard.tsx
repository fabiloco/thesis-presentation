...
export const ObjectiveCard: FC<ObjectiveCardProps> = ({ text, isGeneral }) => {
  const generalObjective = (
    <div
      /* style={{
        backgroundImage: "url(https://picsum.photos/1000/1000/?blur=3)",
        backgroundRepeat: "no-repeat",
        backgroundSize: "cover",
      }} */
      className="w-full h-full relative row-span-2 text-neutral-50 bg-opacity-80 bg-neutral-950 flex flex-col justify-center items-center "
    >
      <img
        src="https://picsum.photos/1000/1000/?blur=4"
        className="absolute top-0 w-full h-full object-cover z-10"
      />
      <div className="z-20 bg-neutral-950 bg-opacity-60 w-full h-full flex flex-col justify-center text-white p-20 ">
  ...
  const specificObjective = (
    <div
      /*   style={{
        backgroundImage: "url(https://picsum.photos/1000/1000/?blur=2)",
        backgroundRepeat: "no-repeat",
        backgroundSize: "cover",
      }} */
      className="h-full w-full relative col-start-2 text-neutral-50 bg-opacity-80 bg-neutral-950 flex flex-col justify-center items-center"
    >
      <img
        src="https://picsum.photos/1000/1000/?blur=2"
        className="absolute top-0 w-full h-full object-cover z-0"
      />
      <div className="z-20 bg-neutral-950 bg-opacity-60 w-full h-full flex flex-col justify-center items-center text-white p-20   ">
